...
export const Prices = [
  {
    ...
    price: "229",
    details:
      "Access to signals and support for One month , To have included Cornix , Automation , or API-signals , you need them before purchase",
  },
  {
    title: "Blue Premium :: 1",
    time: "6 Month",
    price: "449",
    details:
      "Access to signals and support for six month , To have included Cornix , Automation , or API-signals , you need them before purchase",
  },
  {
    title: "Blue Premium :: infinity",
    time: "Lifetime",
    price: "899",
    details:
